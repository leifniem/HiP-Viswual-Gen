import { disableTransitionTemporarily, forceReflow, } from '../../../common/dom-util';
 ...
 */
export function createFoldable(expanded) {
 ...
 */
export function getFoldableStyleExpanded(foldable) {
    return foldable.styleExpanded;
}
/**
 * @deprecated Use foldable.styleHeight instead.
 */
export function getFoldableStyleHeight(foldable) {
